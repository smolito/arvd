...
# vykreslit c�ry
lines(lowess(data$Sepal.Length[data$Species=='setosa'],
             data$Sepal.Width[data$Species=='setosa']))

lines(lowess(data$Sepal.Length[data$Species=='versicolor'],
             data$Sepal.Width[data$Species=='versicolor']),col=2)

lines(lowess(data$Sepal.Length[data$Species=='virginica'],
             data$Sepal.Width[data$Species=='virginica']),col=3)
...
hist(Ixos, breaks=30, xlim=c(0,300), col=rgb(1,0,0,0.5), xlab="v�ska [cm]", 
...
legend("topright", legend=c("rostlina 1","rostlina 2"), col=c(rgb(1,0,0,0.5), 
